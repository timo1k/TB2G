...
const Building = ({ params }) => {
  ...
  return (
    <div className="min-w-full max-w-full min-h-full h-screen bg-white border-black border-2">
      <div className="flex flex-col items-center w-full p-5 text-center font-bold text-6xl justify-center bg-white">
        TB2G
      </div>

      <h1 className="text-black text-3xl md:text-4xl lg:text-4xl xl:text-4xl pl-12 pt-7">{id}</h1>
      <br></br>
